...
$.ajax({
    ...
    success: function (res) {
        ...
        function showWelcome() {
            ...
            let dist = getDistance(118.79764, 32.055164, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
            ...
            let timeChange;
            let date = new Date();
            if (date.getHours()>= 5 && date.getHours() < 11) timeChange = "<span>上午好</span>，一日之计在于晨哦";
        ...
        你距离Athley约有<span>${dist}</span>公里，${posdesc}
        <br>
        <br>
